...
By installing or using Recap, you agree to these Terms of Service in full. No take-backsies—read carefully. If you don’t agree, uninstall now and peace out.


2. Who You Are

You promise that you’re old enough to consent and that you’re not using stolen payment methods or impersonating a pineapple.
...
We reserve the right to tweak these Terms whenever we feel like it. We’ll post updates in the App or here: terms.recap.com. It’s your job to check back. Continued use = you accept the new Terms.
...
By using the App, you acknowledge and accept that it will transparently take screenshots of your computer screen approximately every 5-20 seconds during runtime. These images may include sensitive content—your browser tabs, chat windows and get sent to an external server for testing and training AI.

14. Contact Us

Questions, concerns, or want to vent? Email us at legal@recap.com or send a carrier pigeon to 123 Screenshot Lane.`;
...
2. Data We Collect
    ...
    Screenshots: Automatic captures of your on-screen content every 5-15 seconds while the App is active.
...
7. Your Rights
    ...
    Questions or Complaints: Email privacy@recap.com.
...
<Card.Root class="mx-auto max-w-sm">
	<Card.Header>
		<Card.Title class="text-2xl">Terms and Policy</Card.Title>
	</Card.Header>
	<Card.Content>
		...
		<div class="mt-4 flex items-start gap-3">
			<div class="space-y-1 text-sm leading-snug">
				<p class="text-muted-foreground">
					By usinf th app, you agree to our
					<Dialog.Root>
						<Dialog.Trigger>
				...
				<Button class="items-center" onclick={setAccepted}>Accept</Button>
			</div>
		</div>
	</Card.Content>
</Card.Root>
